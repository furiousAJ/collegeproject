...
const Sellersidebar = () => {
  ...
  return (
    <div className='sidebar'>
      <div className="top"><Link to="/seller" style={{textDecoration:"none"}}>
...
<hr/>
      <div className="center">
        <ul>
            ...
            <li><Link to="/productlist" style={{textDecoration:"none"}}>
...
{/*            
            ...
            <li onClick={handleLogout} style={{textDecoration:"none"}}>
